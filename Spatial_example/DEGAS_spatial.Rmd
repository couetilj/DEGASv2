...
knitr::opts_knit$set(root.dir = "/N/project/ADNDD/Foundation/DEGAS_torch/spatial_example")
```
...
root_dir <- "/N/project/ADNDD/Foundation/DEGAS_torch/spatial_example/"
```
